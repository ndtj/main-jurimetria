...
- Diversos quizzes a serem resolvidos sala de aula.

- Uma prova escrita.

- Um trabalho final, a ser entregue na forma de relatório e seminário.
...
- Para o trabalho final, vocês se organizarão em grupos e definirão um tema de pesquisa.

- O tema poderá ser relacionado a alguma disciplina que você está cursando, por exemplo, ou algum tema de seu interesse.

- Vamos desenvolver um estudo jurimétrico simples sobre esse tema.
...
- __Prova__: 60%
- __Trabalho final__: 40%

--

.pull-left[

Daremos 0,5 __adicional__ para quem resolver todos os quizzes dados em aula.

]

.pull-right[

Daremos 0,5 __adicional__ para quem entregar 2 resumos ou mais.
